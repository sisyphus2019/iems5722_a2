...
public class ChatActivity extends AppCompatActivity {
    ...
    public void sendMessage(View view) {
        ...
        if (text.length()==0)
        {
            ...
            messageBean.setUser_id(getResources().getInteger(R.integer.myUserId));
            ...
            sendMessageAsyncTask.execute(urlStr,chatroom_id+"",getResources().getInteger(R.integer.myUserId)+"",getString(R.string.myName),text);
    ...
    public void get_messagesJSON(String json_string){
        try{
            ...
            for (int i=array.length()-1;i>=0;i--){
                ...
                //isSelf
                if (user_id == getResources().getInteger(R.integer.myUserId)){
                    messageBean.setIsSelf(true);
                }else {
